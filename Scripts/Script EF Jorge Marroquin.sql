...
pk_codigo_producto int not null primary key,
Nombre varchar(100),
...
pk_inventario int not null primary key,
...
pk_facturacion int not null primary key,
fk_nit int not null,
fk_codigo_producto int not null,
total int,
foreign key (fk_codigo_producto) references tbl_productos (pk_codigo_producto),
foreign key (fk_nit) references tbl_Clientes (Nit)
);
...
('5', 'examen', 'examen', 'examen', 'X9yc1/l1b2A==', 'examen@gmail.com', '2022-07-02 21:00:48', '1','COLOR FAVORITO','TdX9j/kyyKM='),
